...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.esc_btn).wait(6).to({_off:false},0).wait(3).to({scaleX:1.0038,scaleY:1.0038,x:950,y:80},0).wait(1).to({scaleX:1,scaleY:1},0).wait(1).to({x:1123.5,y:117.35},0).to({_off:true},1).wait(7));
